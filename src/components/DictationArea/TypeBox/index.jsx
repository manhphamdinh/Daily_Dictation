...
function TypeBox({ onJump, currentSentence, onNext, currentIndex, lessonSentences, onPrevious, onNextArrow, onCorrect, isCompleted, dictation, onReview, audioRef, onPlayStateChange, src }) {
    ...
    const renderInputWithUnderlines = () => {
        ...
        const correctText = currentSentence?.text || "I've been meaning to ask you for some advice about restaurants.";
